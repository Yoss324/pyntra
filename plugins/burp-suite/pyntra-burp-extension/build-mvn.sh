...
if command -v mvn >/dev/null 2>&1; then
  ...
  MAVEN_VERSION="3.9.6"
  BASE_DIR="${HOME}/.cache/pyntra-burp-extension"
...
cp "$ROOT_DIR/target/pyntra-burp-extension-1.0.0.jar" "$DIST_DIR/pyntra-burp-extension.jar"
echo "[+] Done: $DIST_DIR/pyntra-burp-extension.jar"
