...
/** Chat:Eino /api/multi-agent/stream,body orchestration */
...
function getWebshellConnections() {
 ...
 .catch(function (e) {
 console.warn(' WebShell connectionfailed', e);
 return [];
 });
}
...
function wsT(key) {
 ...
 'webshell.addConnection': 'connection',
 'webshell.cmdParam': '',
 'webshell.cmdParamPlaceholder': ' cmd, xxx xxx=',
 'webshell.connections': 'connection',
 'webshell.noConnections': 'connection,「connection」',
 'webshell.selectOrAdd': 'connection, WebShell connection',
 'webshell.deleteConfirm': 'deleteconnection？',
 'webshell.editConnection': '',
 'webshell.editConnectionTitle': 'connection',
 'webshell.tabTerminal': '',
 'webshell.tabFileManager': 'File Management',
 'webshell.tabAiAssistant': 'AI ',
 'webshell.tabDbManager': 'database',
 'webshell.tabMemo': '',
 'webshell.dbType': 'database',
 'webshell.dbHost': '',
 'webshell.dbPort': '',
 'webshell.dbUsername': '',
 'webshell.dbPassword': 'password',
 'webshell.dbName': 'database',
 'webshell.dbSqlitePath': 'SQLite Filespath',
 'webshell.dbSqlPlaceholder': 'input SQL,:SELECT version();',
 'webshell.dbRunSql': ' SQL',
 'webshell.dbTest': 'connection',
 'webshell.dbOutput': 'output',
 'webshell.dbNoConn': ' WebShell connection',
 'webshell.dbSqlRequired': 'input SQL',
 'webshell.dbRunning': 'databaseRunning,',
 'webshell.dbCliHint': 'hintdoes not exist,(mysql/psql/sqlite3/sqlcmd)',
 'webshell.dbExecFailed': 'Database execution failed',
 'webshell.dbSchema': 'database',
 'webshell.dbLoadSchema': 'load',
 'webshell.dbNoSchema': 'database,load',
 'webshell.dbSelectTableHint': 'generatequery SQL',
 'webshell.dbNoColumns': '',
 'webshell.dbResultTable': 'result',
 'webshell.dbClearSql': ' SQL',
 'webshell.dbTemplateSql': ' SQL',
 'webshell.dbRows': '',
 'webshell.dbColumns': '',
 'webshell.dbSchemaFailed': 'loaddatabasefailed',
 'webshell.dbSchemaLoaded': 'loadcompleted',
 'webshell.dbAddProfile': 'connection',
 'webshell.dbExecSuccess': 'SQL successful',
 'webshell.dbNoOutput': 'completed(output)',
 'webshell.dbRenameProfile': 'Rename',
 'webshell.dbDeleteProfile': 'deleteconnection',
 'webshell.dbDeleteProfileConfirm': 'deletedatabaseconnectionconfig？',
 'webshell.dbProfileNamePrompt': 'inputconnectionname',
 'webshell.dbProfileName': 'connectionname',
 'webshell.dbProfiles': 'databaseconnection',
 'webshell.aiSystemReadyMessage': 'The system is ready. Enter your testing request and the system will run the corresponding security checks automatically.',
 'webshell.aiPlaceholder': ':currentdirectoryFiles',
 'webshell.aiSend': '',
 'webshell.aiMemo': '',
 'webshell.aiMemoPlaceholder': 'record//...',
 'webshell.aiMemoClear': '',
 'webshell.aiMemoSaving': 'save...',
 'webshell.aiMemoSaved': 'save',
 'webshell.terminalWelcome': 'WebShell — input(Ctrl+L )',
 'webshell.quickCommands': '',
 'webshell.downloadFile': '',
 'webshell.filePath': 'currentpath',
 'webshell.listDir': 'directory',
 'webshell.readFile': '',
 'webshell.editFile': '',
 'webshell.deleteFile': 'delete',
 'webshell.saveFile': 'save',
 'webshell.cancelEdit': 'cancel',
 'webshell.parentDir': 'directory',
 'webshell.execError': 'failed',
 'webshell.testConnectivity': '',
 'webshell.testSuccess': ',Shell ',
 'webshell.testFailed': 'failed',
 'webshell.testNoExpectedOutput': 'Shell backoutput,connectionpassword',
 'webshell.clearScreen': '',
 'webshell.copyTerminalLog': 'logs',
 'webshell.terminalIdle': '',
 'webshell.terminalRunning': 'Running',
 'webshell.terminalCopyOk': 'logs',
 'webshell.terminalCopyFail': 'Copy failed',
 'webshell.terminalNewWindow': '',
 'webshell.terminalWindowPrefix': '',
 'webshell.running': 'Running…',
 'webshell.waitFinish': 'currentcompleted',
 'webshell.newDir': 'directory',
 'webshell.rename': 'Rename',
 'webshell.upload': '',
 'webshell.newFile': 'Files',
 'webshell.filterPlaceholder': 'Files',
 'webshell.batchDelete': 'delete',
 'webshell.batchDownload': '',
 'webshell.moreActions': '',
 'webshell.refresh': 'refresh',
 'webshell.selectAll': '',
 'webshell.breadcrumbHome': '',
 'webshell.dirTree': 'directory',
 'webshell.searchPlaceholder': 'connection...',
 'webshell.noMatchConnections': 'connection',
 'webshell.batchProbe': '',
 'webshell.probeRunning': '',
 'webshell.probeOnline': '',
 'webshell.probeOffline': '',
 'webshell.probeNoConnections': 'connection',
 'webshell.back': 'back',
...
function probeWebshellConnection(conn) {
 ...
 if (ok) return { ok: true, message: wsT('webshell.testSuccess') || 'Connection OK, shell is reachable' };
...
function simplifyWebshellAiError(rawMessage) {
 ...
 return 'failed:API Key configinvalid(401)';
 }
...
function isLikelyWebshellAiErrorMessage(content, msg) {
 ...
 if (/^(failed|Request failed||error)\s*[::]/i.test(text)) return true;
 if (/(status code\s*:\s*4\d{2}|unauthorized|forbidden|apikey|api key|invalid api key)/i.test(lower)) return true;
 if (/(noderunerror|tool[-_ ]?error|agent[-_ ]?error|failed)/i.test(lower)) return true;
...
function renderWebshellProcessDetailsBlock(processDetails, defaultCollapsed) {
 ...
 var headerLabel = (typeof window.t === 'function') ? (window.t('chat.penetrationTestDetail') || 'processcalltool') : 'processcalltool';
...
function fetchAndRenderWebshellAiConvList(conn, listEl) {
 ...
 .catch(function (e) { console.warn('loadChatfailed', e); });
}
...
function webshellAiConvListSelect(conn, convId, messagesContainer, listEl) {
 ...
 if (list.length === 0) {
 var readyMsg = wsT('webshell.aiSystemReadyMessage') || 'System is ready. Please enter your test requirements, and the system will automatically perform the corresponding security tests.';
...
function selectWebshell(id, stateReady) {
 ...
 '<button type="button" class="btn-ghost btn-sm" id="webshell-terminal-clear" title="' + (wsT('webshell.clearScreen') || 'Clear') + '">' + (wsT('webshell.clearScreen') || 'Clear') + '</button> ' +
 ...
 '<div class="webshell-file-sidebar-title">' + wsTOr('webshell.dirTree', 'directory') + '</div>' +
 ...
 '<input type="text" id="webshell-file-filter" class="form-control webshell-file-filter" placeholder="' + (wsT('webshell.filterPlaceholder') || 'Filter by name') + '" />' +
 ...
 '<textarea id="webshell-ai-input" class="webshell-ai-input form-control" rows="2" placeholder="' + (wsT('webshell.aiPlaceholder') || 'e.g. List files in the current directory') + '"></textarea>' +
 ...
 '<textarea id="webshell-ai-memo-input" class="webshell-memo-input form-control" rows="18" placeholder="' + (wsT('webshell.aiMemoPlaceholder') || 'Save key commands, testing ideas, and repro steps...') + '"></textarea>' +
 ...
 '<div id="webshell-db-schema-tree" class="webshell-db-schema-tree"><div class="webshell-empty">' + (wsT('webshell.dbNoSchema') || 'No schema yet, click Load Schema') + '</div></div>' +
 '<div class="webshell-db-sidebar-hint">' + (wsT('webshell.dbSelectTableHint') || 'Click a table to expand columns and generate SQL') + '</div>' +
 '</aside>' +
 '<section class="webshell-db-main">' +
 '<div class="webshell-db-sql-tools"><button type="button" class="btn-ghost btn-sm" id="webshell-db-template-btn">' + (wsT('webshell.dbTemplateSql') || 'SQL Template') + '</button><button type="button" class="btn-ghost btn-sm" id="webshell-db-clear-btn">' + (wsT('webshell.dbClearSql') || 'Clear SQL') + '</button></div>' +
 ...
 '</div>' +
 '<div class="webshell-db-output-wrap"><div class="webshell-db-output-title">' + (wsT('webshell.dbOutput') || 'Output') + '</div><div id="webshell-db-result-table" class="webshell-db-result-table"></div><pre id="webshell-db-output" class="webshell-db-output"></pre><div class="webshell-db-hint">' + (wsT('webshell.dbCliHint') || 'If command not found appears, install mysql/psql/sqlite3/sqlcmd on the target host first') + '</div></div>' +
 ...
 '<label><span>' + (wsT('webshell.dbProfileName') || 'connectionname') + '</span><input id="webshell-db-profile-name" class="form-control" type="text" maxlength="30" /></label>' +
 ...
 if (!dbs.length) {
 dbSchemaTreeEl.innerHTML = '<div class="webshell-empty">' + escapeHtml(wsT('webshell.dbNoSchema') || 'No schema yet, click Load Schema') + '</div>';
 return;
 }
 ...
 html += '<div class="webshell-db-column-empty">' + escapeHtml(wsT('webshell.dbNoColumns') || 'No column details') + '</div>';
 }
 html += '</details>';
 });
 html += '</div></details>';
 ...
 if (!built.command) {
 webshellDbSetOutput(built.error || (wsT('webshell.dbSchemaFailed') || 'Failed to load schema'), true);
 return;
 }
 ...
 var success = parsed.rc === 0 || (parsed.rc == null && parsed.output && !/error|failed|denied|unknown|not found|access/i.test(parsed.output));
 if (!success) {
 webshellDbSetOutput((wsT('webshell.dbSchemaFailed') || 'Failed to load schema') + ':\n' + (parsed.output || ''), true);
 return;
 }
 ...
 webshellDbSetOutput((wsT('webshell.dbSchemaFailed') || 'Failed to load schema') + ': ' + (err && err.message ? err.message : String(err)), true);
 }).finally(function () {
 webshellRunning = false;
 setDbActionButtonsDisabled(false);
 });
 ...
 if (isTestOnly) {
 if (success) {
 cfg.output = 'connection';
 cfg.outputIsError = false;
 saveWebshellDbConfig(conn, cfg);
 webshellDbSetOutput(cfg.output, false);
 } else {
 cfg.output = 'connectionfailed' + (content ? (':\n' + content) : '');
 ...
 cfg.output = content || (wsT('webshell.dbNoOutput') || 'Execution completed (no output)');
 cfg.outputIsError = false;
 saveWebshellDbConfig(conn, cfg);
 webshellDbSetOutput(cfg.output, false);
 }
...
function loadWebshellAiHistory(conn, messagesContainer) {
 ...
 .catch(function (e) {
 console.warn('load WebShell AI failed', conn.id, e);
 });
}
...
function runWebshellAiSend(conn, inputEl, sendBtn, messagesContainer) {
 ...
 errDiv.textContent = ':login apiFetch ';
 ...
 renderWebshellAiErrorMessage(assistantDiv, ': ' + (err && err.message ? err.message : String(err)));
 }).then(function () {
...
function initWebshellTerminal(conn) {
 ...
 if (container) {
 container.innerHTML = '<p class="terminal-error">' + escapeHtml('load xterm.js,refreshpage') + '</p>';
 }
 return;
 }
 ...
 writeWebshellOutput(term, '^C (Current version)', true);
 appendWebshellTerminalLog(terminalKey, '^C (Current version)\n');
 }
 webshellLineBuffer = '';
 webshellHistoryIndex = -1;
 term.write(WEBSHELL_PROMPT);
 ...
 appendWebshellTerminalLog(terminalKey, (wsT('webshell.waitFinish') || 'Please wait for the current command to finish') + '\n');
 term.write(WEBSHELL_PROMPT);
 return;
 }
 pushWebshellHistory(terminalKey, cmd);
...
function renderDirectoryTree(currentPath, items, conn) {
 ...
 if (!state) {
 treeEl.innerHTML = '<div class="webshell-empty">directory</div>';
 return;
 }
 var tree = state.tree;
...
function webshellBatchDelete(conn, pathInput) {
 ...
 if (paths.length === 0) { alert(wsT('webshell.batchDelete') + ':Files'); return; }
...
function webshellBatchDownload(conn, pathInput) {
 ...
 var paths = [];
 checked.forEach(function (cb) { paths.push(cb.getAttribute('data-path')); });
 if (paths.length === 0) { alert(wsT('webshell.batchDownload') + ':Files'); return; }
...
function deleteWebshell(id) {
 ...
 .catch(function (e) {
 console.warn('delete WebShell connectionfailed', e);
...
function refreshWebshellUIOnLanguageChange() {
 ...
 if (terminalClearBtn) {
 terminalClearBtn.title = wsT('webshell.clearScreen') || 'Clear';
 terminalClearBtn.textContent = wsT('webshell.clearScreen') || 'Clear';
 }
 ...
 if (filterInput) filterInput.placeholder = wsT('webshell.filterPlaceholder') || 'Filter by name';
 var aiNewConvBtn = document.getElementById('webshell-ai-new-conv');
 if (aiNewConvBtn) aiNewConvBtn.textContent = wsT('webshell.aiNewConversation') || 'New conversation';
 var aiInput = document.getElementById('webshell-ai-input');
 if (aiInput) aiInput.placeholder = wsT('webshell.aiPlaceholder') || 'e.g. List files in the current directory';
 var aiSendBtn = document.getElementById('webshell-ai-send');
 ...
 var aiMemoInput = document.getElementById('webshell-ai-memo-input');
 if (aiMemoInput) aiMemoInput.placeholder = wsT('webshell.aiMemoPlaceholder') || 'Save key commands, testing ideas, and repro steps...';
 var aiMemoStatus = document.getElementById('webshell-ai-memo-status');
 ...
 if (dbProfileNameLabel && dbProfileNameLabel.querySelector('span')) dbProfileNameLabel.querySelector('span').textContent = wsT('webshell.dbProfileName') || 'connectionname';
 ...
 var dbTemplateBtn = document.getElementById('webshell-db-template-btn');
 if (dbTemplateBtn) dbTemplateBtn.textContent = wsT('webshell.dbTemplateSql') || 'SQL Template';
 var dbClearBtn = document.getElementById('webshell-db-clear-btn');
 ...
 if (dbTitle) dbTitle.textContent = wsT('webshell.dbOutput') || 'Output';
 var dbHint = document.querySelector('.webshell-db-hint');
 if (dbHint) dbHint.textContent = wsT('webshell.dbCliHint') || 'If command not found appears, install mysql/psql/sqlite3/sqlcmd on the target host first';
 var dbTreeHint = document.querySelector('.webshell-db-sidebar-hint');
 if (dbTreeHint) dbTreeHint.textContent = wsT('webshell.dbSelectTableHint') || 'Click a table to expand columns and generate SQL';
 var dbAddProfileBtn = document.getElementById('webshell-db-add-profile-btn');
 ...
 dbTree.innerHTML = '<div class="webshell-empty">' + escapeHtml(wsT('webshell.dbNoSchema') || 'No schema yet, click Load Schema') + '</div>';
 }
 var aiMessages = document.getElementById('webshell-ai-messages');
 if (aiMessages) {
...
function testWebshellConnection() {
 ...
 if (reallyOk) {
 alert(wsT('webshell.testSuccess') || 'Connection OK, shell is reachable');
 } else {
 var msg;
 if (data.ok && output !== '1')
 msg = wsT('webshell.testNoExpectedOutput') || 'Shell responded but expected output was not found. Check password and command parameter name.';
 else
...
function saveWebshellConnection() {
 ...
 .catch(function (e) {
 console.warn('save WebShell connectionfailed', e);
